...
const myScriptBuildUI = (thisObj) => {
  ...
  const onionSkinButton = groupOne.add('iconbutton', [0, 0, 24, 24], loadImage(onionSkinIcon), { style: 'toolbutton', toggle: false });
  ...
  const createFoldersButton = groupOne.add('iconbutton', [0, 0, 24, 24], loadImage(addFoldersIcon), { style: 'toolbutton', toggle: false });
  ...
  const setSameLabelColorsButton = groupOne.add('iconbutton', [0, 0, 24, 24], loadImage(fillFoldersIcon), { style: 'toolbutton', toggle: false });
  ...
  const clearShapeButton = groupTwo.add('iconbutton', [0, 0, 24, 24], loadImage(clearShapeIcon), { style: 'toolbutton', toggle: false });
  ...
  const separateShapesSingleLayerButton = groupTwo.add('iconbutton', [0, 0, 24, 24], loadImage(subpshapesToSingleIcon), { style: 'toolbutton', toggle: false });
  ...
  const separateShapesDifferentLayersButton = groupTwo.add('iconbutton', [0, 0, 24, 24], loadImage(subpshapesToDifferentIcon), { style: 'toolbutton', toggle: false });
  ...
  const creaditsButton = groupThree.add('iconbutton', [0, 0, 18, 18], loadImage(untimeLogoIcon), { style: 'toolbutton', toggle: false });
  ...
  const helpButton = groupThree.add('button', undefined, '?');
  ...
  myPanel.onResize = () => thisObj.layout.resize();
